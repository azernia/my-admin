...
public class GlobalExceptionHandler {
    ...
    public RespBean bindExceptionHandler(BindException e) {
        ...
        if (!Objects.isNull(fieldError)) {
            ...
            return RespBean.fail(RespConstants.ERROR_CODE, fieldError.getDefaultMessage());
        }
        return RespBean.fail(RespConstants.ERROR_CODE, "系统异常");
    }
    ...
    public RespBean accessDeniedExceptionHandler(AccessDeniedException accessDeniedException) {
        ...
        return RespBean.fail(RespConstants.ERROR_CODE, accessDeniedException.getMessage());
    }
